...
public class ApplicationListener extends ApplicationListenerHandler {
	...
	public void contextInitialized(ServletContextEvent event) {
		...
		if (rootPath==null) {
			...
			sv=null;
			System.out.println("com.esed.easybridge.webservice.listener.ApplicationListener - Path file di configurazione letto da variabile: " + rootPath); //GG
		} 
		if (rootPath!=null) {
			...
			*/
			System.out.println("com.esed.easybridge.webservice.listener.ApplicationListener - Caricamento configurazioni");	//GG
		}
	}
}